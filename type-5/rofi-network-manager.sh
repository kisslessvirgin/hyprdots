...
function initialization() {
	...
	{ [[ -f "$DIR/style-4.rasi" ]] && RASI_DIR="$DIR/style-4.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/rofi/applets/type-5/style-4.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/applets/type-5/style-4.rasi"; } || exit
